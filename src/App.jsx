...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      {/* Main Content */}
      <main className={`flex-1 ${activeTab === 'explorer' ? 'flex flex-col lg:overflow-hidden' : activeTab === 'chat' ? 'flex flex-col overflow-hidden' : 'max-w-[1400px] mx-auto w-full px-4 sm:px-6 py-6'}`}>
        {activeTab === 'explorer' && (
          <DailyExplorer
            apiKey={apiKey}
